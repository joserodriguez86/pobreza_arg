...
ggsave("salidas/gini_evolucion.png", dpi = 300, width = 8, height = 5)
```
...
ggsave("salidas/desocupacion_evolucion.png", dpi = 300, width = 8, height = 5)
```
...
ggsave("salidas/pobreza_intensi.png", dpi = 300, width = 8, height = 5)
...
elipsis <- cloud_ind_2017 + theme(legend.position = "none") | 
