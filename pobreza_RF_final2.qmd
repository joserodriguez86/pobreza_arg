...
ggsave("salidas/rf_train1.png", width = 8, height = 5)
...
ggsave("salidas/rf_train2.png", width = 8, height = 5)
...
ggsave("salidas/rf_train3.png", width = 8, height = 5)
...
ggsave("salidas/rf_train4.png", width = 8, height = 5)
...
ggsave("salidas/metricas_over.png", width = 8, height = 5)
```
