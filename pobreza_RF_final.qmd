...
extract_fit_parsnip(tree_rf2) %>%
  vip::vip(geom = "col", num_features = 22) + 
  labs(title = "Variables importantes del modelo de entrenamiento de 2018-II019 \n(método permutación)",
...
datasets <- list(
  list(data = train1, label = "Train1", ano_trim = "2016-III", tipo = "Entrenamiento"),
  list(data = test_20171, label = "Test 2017-I", ano_trim = "2017-I", tipo = "Test"),
  list(data = test_20172, label = "Test 2017-II", ano_trim = "2017-II", tipo = "Test"),
  list(data = test_20173, label = "Test 2017-III", ano_trim = "2017-III", tipo = "Test"),
  list(data = test_20174, label = "Test 2017-IV", ano_trim = "2017-IV", tipo = "Test"),
  list(data = test_20181, label = "Test 2018-I", ano_trim = "2018-I", tipo = "Test"),
  list(data = test_20182, label = "Test 2018-II", ano_trim = "2018-II", tipo = "Test"),
  list(data = test_20183, label = "Test 2018-III", ano_trim = "2018-III", tipo = "Test")
)
...
# Definir las bases y etiquetas
datasets <- list(
  list(data = train2, label = "Train2", ano_trim = "2018-IV / 2019-I", tipo = "Entrenamiento"),
  list(data = test_20192, label = "Test 20192", ano_trim = "2019-2", tipo = "Test"),
  list(data = test_20193, label = "Test 20193", ano_trim = "2019-3", tipo = "Test"),
  list(data = test_20194, label = "Test 20194", ano_trim = "2019-4", tipo = "Test"),
  list(data = test_20201, label = "Test 20201", ano_trim = "2020-1", tipo = "Test")
)
...
# Definir las bases y etiquetas
datasets <- list(
  list(data = train1, label = "Train3", ano_trim = "2021-I / 2021-II", tipo = "Entrenamiento"),
...
# Definir las bases y etiquetas
datasets <- list(
  list(data = train1, label = "Train4", ano_trim = "2023-IV / 2024-I", tipo = "Entrenamiento"),
...
# Definir las bases y etiquetas
datasets <- list(
  list(data = train1, label = "Train2", ano_trim = "2018-IV / 2019-I", tipo = "Entrenamiento"),
  list(data = test_20192, label = "Test 20192", ano_trim = "2019-II", tipo = "Test"),
  list(data = test_20193, label = "Test 20193", ano_trim = "2019-III", tipo = "Test"),
  list(data = test_20194, label = "Test 20194", ano_trim = "2019-IV", tipo = "Test"),
  list(data = test_20201, label = "Test 20201", ano_trim = "2020-I", tipo = "Test")
)
...
roc_data <- roc_curve(matriz4, truth = pobreza_dic, ".pred_Pobre")

prevalence <- mean(matriz4$pobreza_dic == "Pobre", na.rm = T)
...
Con ese umbral se llega a un 83% de tasa de aciertos